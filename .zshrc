...
export ZSH="/Users/dannypark/.oh-my-zsh"
...
alias occ='cd ~/workspace/occupier'
...
alias log='git log'
alias dbpull='heroku pg:pull DATABASE occupier_development --app occupier-staging'
...
function glc {
  ...
  read "num?enter branch num to checkout to: "
